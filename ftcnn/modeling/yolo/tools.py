...
from pandas.io.xml import PathLike
...
from ftcnn.modeling.utils import write_classes
from ftcnn.modeling.yolo.utils import (
...
def create_truth_and_prediction_pairs(
    truth_images_dir: os.PathLike,
    truth_labels_dir: os.PathLike,
    pred_images_dir: PathLike,
...
def draw_yolo_bboxes(
    image_path: PathLike, label_path: PathLike, class_names: None | list[str] = None
) -> MatLike:
    """
