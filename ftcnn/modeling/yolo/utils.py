...
from ftcnn.modeling.utils import XYInt, extract_annotated_label_and_image_data
...
def remove_annotations_not_in(class_ids: list[str | int], *, labels_dir: PathLike):
    """
...
def recategorize_classes(
    classes: dict[str | int, str], labels_dir: PathLike
